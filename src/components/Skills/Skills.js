        ...
        return (
            ...
            <div className="card border-primary mb-3">
                ...
                <div className="card-body">
                    <h3 className="card-text skills">Web Technology <i class="fa fa-laptop" aria-hidden="true"></i></h3>
                    ...
                    <h3 className="card-text skills">
                        Version Control <i class="fa fa-code-fork" aria-hidden="true"></i>
                    ...
                    <h3 className="card-text skills">
                        Databases <i class="fa fa-database" aria-hidden="true"></i>
                    </h3> 
                    ...
                    <h3 className="card-text skills">
                        Testing Tools <i class="fa fa-check" aria-hidden="true"></i>
